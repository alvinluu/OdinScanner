...
//    [moc performBlock:^{
        ...
        textDate = [lastStudDate asStringWithNSDate];
...
-(void)failToPostToWebservice:(UIView *)vc
{
	[self showInView:vc
			 ...
			 message:@"Transaction is charged but failed to Post. Saved to Pending"
	 ];
}

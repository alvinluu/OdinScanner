...
+ (NSDictionary *)getAuthStatus
{
	...
	[authRequest setPostBody:[WebService bodyAsJSONDataFromDict:[self getDefaultParameters]]];
...
{	
	...
	itemRequest = [WebService createPOSTRequestWithResource:@"Items" andParams:requestParams];
...
+(NSArray *)studentFetchMiddleman:(NSString *)id_number
{
	...
	do {
		...
		//create Request and start it
		studentRequest = [WebService createPOSTRequestWithResource:@"Students" andParams:requestParams];
...
{	
	...
	ASIFormDataRequest *accntTypeRequest = [WebService createPOSTRequestWithResource:@"AccountType" andParams:requestParams];	
...
//#endif
//	
//	ASIFormDataRequest *transactionPostRequest = [WebService createPOSTRequestWithResource:@"TransactionLogWrite" andBody:curTrans];
//	
...
+ (BOOL)postUploadedTransaction:(NSDictionary *)transaction
{
	...
	ASIFormDataRequest *transactionPostRequest = [WebService createPOSTRequestWithResource:@"TransactionUploaded" andParams:requestParams];
...
+ (BOOL)postTransaction:(NSDictionary *)transaction
{
	...
	ASIFormDataRequest *transactionPostRequest = [WebService createPOSTRequestWithResource:@"Transaction" andParams:requestParams];

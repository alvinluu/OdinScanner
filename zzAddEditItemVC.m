...
#import "zzAddEditItemVC.h"
#import "MBProgressHUD.h"


@interface zzAddEditItemVC ()
...
@implementation zzAddEditItemVC
...
{// Run multiple checks to see if input is good
	...
	else if([[CoreDataHelper searchObjectsForEntity:@"OdinEvent" 
...
-(IBAction)saveItem
{
	if ([self inputChecksOut])
	{
		...
		OdinEvent *item = nil;
		NSArray *possibleItems = [CoreDataHelper searchObjectsForEntity:@"OdinEvent" 
		...
		{
			item = (OdinEvent *)[CoreDataHelper insertObjectForEntity:@"OdinEvent" andContext:self.managedObjectContext];		
		}
